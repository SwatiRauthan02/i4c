...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/performance_style.css?a=5" />
    ...
    <style type="text/css">
      .tooltipster-content{font-size: 13px !important;line-height: 14px !important;letter-spacing: 1px;}
    </style>
  </head>
